...
2. ⬜ 插件管理API
3. ⬜ 完善安全隔离机制
4. ➖ 完成所有原生插件的迁移 (已迁移API服务器、RequestId、BasicAuth、OAuth2、LlmRouter、PromptTransformer插件，其他插件迁移进行中)
5. ⬜ 增强核心`Plugin`接口或利用框架能力以支持请求/响应体修改
...
8. **下一步计划**:
   - 继续迁移其他核心插件（如AiSecurity、LlmAggregator等）
   - 探讨并实现核心接口或利用框架能力支持请求/响应体的修改
